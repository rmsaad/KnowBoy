...
gb_instr_t instructions[256] = {{gb_cpu_NOP, {1, 1, 0}},
				{gb_cpu_LOAD_BC_d16, {3, 3, 0}},
				{gb_cpu_LOAD_BC_A, {1, 2, 0}},
				{gb_cpu_INC_BC, {1, 2, 0}},
				{gb_cpu_INC_B, {1, 1, 0}},
				{gb_cpu_DEC_B, {1, 1, 0}},
				{gb_cpu_LOAD_B_d8, {2, 2, 0}},
				{gb_cpu_RLCA, {1, 1, 0}},
				{gb_cpu_LOAD_a16_SP, {3, 5, 0}},
				{gb_cpu_ADD_HL_BC, {1, 2, 0}},
				{gb_cpu_LOAD_A_BC, {1, 2, 0}},
				{gb_cpu_DEC_BC, {1, 2, 0}},
				{gb_cpu_INC_C, {1, 1, 0}},
				{gb_cpu_DEC_C, {1, 1, 0}},
				{gb_cpu_LOAD_C_d8, {2, 2, 0}},
				{gb_cpu_RRCA, {1, 1, 0}},
				{gb_cpu_STOP, {2, 1, 0}},
				{gb_cpu_LOAD_DE_d16, {3, 3, 0}},
				{gb_cpu_LOAD_DE_A, {1, 2, 0}},
				{gb_cpu_INC_DE, {1, 2, 0}},
				{gb_cpu_INC_D, {1, 1, 0}},
				{gb_cpu_DEC_D, {1, 1, 0}},
				{gb_cpu_LOAD_D_d8, {2, 2, 0}},
				{gb_cpu_RLA, {1, 1, 0}},
				{gb_cpu_JR_r8, {2, 3, 0}},
				{gb_cpu_ADD_HL_DE, {1, 2, 0}},
				{gb_cpu_LOAD_A_DE, {1, 2, 0}},
				{gb_cpu_DEC_DE, {1, 2, 0}},
				{gb_cpu_INC_E, {1, 1, 0}},
				{gb_cpu_DEC_E, {1, 1, 0}},
				{gb_cpu_LOAD_E_d8, {2, 2, 0}},
				{gb_cpu_RRA, {1, 1, 0}},
				{gb_cpu_JR_NZ_r8, {2, CUSTOM_CYCLES, 0}},
				{gb_cpu_LOAD_HL_d16, {3, 3, 0}},
				{gb_cpu_LOAD_HLI_A, {1, 2, 0}},
				{gb_cpu_INC_HL, {1, 2, 0}},
				{gb_cpu_INC_H, {1, 1, 0}},
				{gb_cpu_DEC_H, {1, 1, 0}},
				{gb_cpu_LOAD_H_d8, {2, 2, 0}},
				{gb_cpu_DAA, {1, 1, 0}},
				{gb_cpu_JR_Z_r8, {2, CUSTOM_CYCLES, 0}},
				{gb_cpu_ADD_HL_HL, {1, 2, 0}},
				{gb_cpu_LOAD_A_HLI, {1, 2, 0}},
				{gb_cpu_DEC_HL, {1, 2, 0}},
				{gb_cpu_INC_L, {1, 1, 0}},
				{gb_cpu_DEC_L, {1, 1, 0}},
				{gb_cpu_LOAD_L_d8, {2, 2, 0}},
				{gb_cpu_CPL, {1, 1, 0}},
				{gb_cpu_JR_NC_r8, {2, CUSTOM_CYCLES, 0}},
				{gb_cpu_LOAD_SP_d16, {3, 3, 0}},
				{gb_cpu_LOAD_HLD_A, {1, 2, 0}},
				{gb_cpu_INC_SP, {1, 2, 0}},
				{gb_cpu_INC_HL_ADDR, {1, 3, 0}},
				{gb_cpu_DEC_HL_ADDR, {1, 3, 0}},
				{gb_cpu_LOAD_HL_d8, {2, 3, 0}},
				{gb_cpu_SCF, {1, 1, 0}},
				{gb_cpu_JR_C_r8, {2, CUSTOM_CYCLES, 0}},
				{gb_cpu_ADD_HL_SP, {1, 2, 0}},
				{gb_cpu_LOAD_A_HLD, {1, 2, 0}},
				{gb_cpu_DEC_SP, {1, 2, 0}},
				{gb_cpu_INC_A, {1, 1, 0}},
				{gb_cpu_DEC_A, {1, 1, 0}},
				{gb_cpu_LOAD_A_d8, {2, 2, 0}},
				{gb_cpu_CCF, {1, 1, 0}},
				{gb_cpu_LOAD_B_B, {1, 1, 0}},
				{gb_cpu_LOAD_B_C, {1, 1, 0}},
				{gb_cpu_LOAD_B_D, {1, 1, 0}},
				{gb_cpu_LOAD_B_E, {1, 1, 0}},
				{gb_cpu_LOAD_B_H, {1, 1, 0}},
				{gb_cpu_LOAD_B_L, {1, 1, 0}},
				{gb_cpu_LOAD_B_HL, {1, 2, 0}},
				{gb_cpu_LOAD_B_A, {1, 1, 0}},
				{gb_cpu_LOAD_C_B, {1, 1, 0}},
				{gb_cpu_LOAD_C_C, {1, 1, 0}},
				{gb_cpu_LOAD_C_D, {1, 1, 0}},
				{gb_cpu_LOAD_C_E, {1, 1, 0}},
				{gb_cpu_LOAD_C_H, {1, 1, 0}},
				{gb_cpu_LOAD_C_L, {1, 1, 0}},
				{gb_cpu_LOAD_C_HL, {1, 2, 0}},
				{gb_cpu_LOAD_C_A, {1, 1, 0}},
				{gb_cpu_LOAD_D_B, {1, 1, 0}},
				{gb_cpu_LOAD_D_C, {1, 1, 0}},
				{gb_cpu_LOAD_D_D, {1, 1, 0}},
				{gb_cpu_LOAD_D_E, {1, 1, 0}},
				{gb_cpu_LOAD_D_H, {1, 1, 0}},
				{gb_cpu_LOAD_D_L, {1, 1, 0}},
				{gb_cpu_LOAD_D_HL, {1, 2, 0}},
				{gb_cpu_LOAD_D_A, {1, 1, 0}},
				{gb_cpu_LOAD_E_B, {1, 1, 0}},
				{gb_cpu_LOAD_E_C, {1, 1, 0}},
				{gb_cpu_LOAD_E_D, {1, 1, 0}},
				{gb_cpu_LOAD_E_E, {1, 1, 0}},
				{gb_cpu_LOAD_E_H, {1, 1, 0}},
				{gb_cpu_LOAD_E_L, {1, 1, 0}},
				{gb_cpu_LOAD_E_HL, {1, 2, 0}},
				{gb_cpu_LOAD_E_A, {1, 1, 0}},
				{gb_cpu_LOAD_H_B, {1, 1, 0}},
				{gb_cpu_LOAD_H_C, {1, 1, 0}},
				{gb_cpu_LOAD_H_D, {1, 1, 0}},
				{gb_cpu_LOAD_H_E, {1, 1, 0}},
				{gb_cpu_LOAD_H_H, {1, 1, 0}},
				{gb_cpu_LOAD_H_L, {1, 1, 0}},
				{gb_cpu_LOAD_H_HL, {1, 2, 0}},
				{gb_cpu_LOAD_H_A, {1, 1, 0}},
				{gb_cpu_LOAD_L_B, {1, 1, 0}},
				{gb_cpu_LOAD_L_C, {1, 1, 0}},
				{gb_cpu_LOAD_L_D, {1, 1, 0}},
				{gb_cpu_LOAD_L_E, {1, 1, 0}},
				{gb_cpu_LOAD_L_H, {1, 1, 0}},
				{gb_cpu_LOAD_L_L, {1, 1, 0}},
				{gb_cpu_LOAD_L_HL, {1, 2, 0}},
				{gb_cpu_LOAD_L_A, {1, 1, 0}},
				{gb_cpu_LOAD_HL_B, {1, 2, 0}},
				{gb_cpu_LOAD_HL_C, {1, 2, 0}},
				{gb_cpu_LOAD_HL_D, {1, 2, 0}},
				{gb_cpu_LOAD_HL_E, {1, 2, 0}},
				{gb_cpu_LOAD_HL_H, {1, 2, 0}},
				{gb_cpu_LOAD_HL_L, {1, 2, 0}},
				{gb_cpu_HALT, {1, 1, 0}},
				{gb_cpu_LOAD_HL_A, {1, 2, 0}},
				{gb_cpu_LOAD_A_B, {1, 1, 0}},
				{gb_cpu_LOAD_A_C, {1, 1, 0}},
				{gb_cpu_LOAD_A_D, {1, 1, 0}},
				{gb_cpu_LOAD_A_E, {1, 1, 0}},
				{gb_cpu_LOAD_A_H, {1, 1, 0}},
				{gb_cpu_LOAD_A_L, {1, 1, 0}},
				{gb_cpu_LOAD_A_HL, {1, 2, 0}},
				{gb_cpu_LOAD_A_A, {1, 1, 0}},
				{gb_cpu_ADD_A_B, {1, 1, 0}},
				{gb_cpu_ADD_A_C, {1, 1, 0}},
				{gb_cpu_ADD_A_D, {1, 1, 0}},
				{gb_cpu_ADD_A_E, {1, 1, 0}},
				{gb_cpu_ADD_A_H, {1, 1, 0}},
				{gb_cpu_ADD_A_L, {1, 1, 0}},
				{gb_cpu_ADD_A_HL, {1, 2, 0}},
				{gb_cpu_ADD_A_A, {1, 1, 0}},
				{gb_cpu_ADC_A_B, {1, 1, 0}},
				{gb_cpu_ADC_A_C, {1, 1, 0}},
				{gb_cpu_ADC_A_D, {1, 1, 0}},
				{gb_cpu_ADC_A_E, {1, 1, 0}},
				{gb_cpu_ADC_A_H, {1, 1, 0}},
				{gb_cpu_ADC_A_L, {1, 1, 0}},
				{gb_cpu_ADC_A_HL, {1, 2, 0}},
				{gb_cpu_ADC_A_A, {1, 1, 0}},
				{gb_cpu_SUB_B, {1, 1, 0}},
				{gb_cpu_SUB_C, {1, 1, 0}},
				{gb_cpu_SUB_D, {1, 1, 0}},
				{gb_cpu_SUB_E, {1, 1, 0}},
				...
				{gb_cpu_SUB_HL, {1, 2, 0}},
				{gb_cpu_SUB_A, {1, 1, 0}},
				{gb_cpu_SBC_A_B, {1, 1, 0}},
				{gb_cpu_SBC_A_C, {1, 1, 0}},
				{gb_cpu_SBC_A_D, {1, 1, 0}},
				{gb_cpu_SBC_A_E, {1, 1, 0}},
				{gb_cpu_SBC_A_H, {1, 1, 0}},
				{gb_cpu_SBC_A_L, {1, 1, 0}},
				{gb_cpu_SBC_A_HL, {1, 2, 0}},
				{gb_cpu_SBC_A_A, {1, 1, 0}},
				{gb_cpu_AND_B, {1, 1, 0}},
				{gb_cpu_AND_C, {1, 1, 0}},
				{gb_cpu_AND_D, {1, 1, 0}},
				{gb_cpu_AND_E, {1, 1, 0}},
				...
				{gb_cpu_CP_HL, {1, 2, 0}},
				{gb_cpu_CP_A, {1, 1, 0}},
				{gb_cpu_RET_NZ, {1, CUSTOM_CYCLES, 0}},
				{gb_cpu_POP_BC, {1, 3, 0}},
				{gb_cpu_JP_NZ_a16, {3, CUSTOM_CYCLES, 0}},
				{gb_cpu_JP_a16, {3, 4, 0}},
				{gb_cpu_CALL_NZ_a16, {3, CUSTOM_CYCLES, 0}},
				{gb_cpu_PUSH_BC, {1, 4, 0}},
				{gb_cpu_ADD_A_d8, {2, 2, 0}},
				{gb_cpu_RST_00H, {1, 4, 0}},
				{gb_cpu_RET_Z, {1, CUSTOM_CYCLES, 0}},
				{gb_cpu_RET, {1, 4, 0}},
				{gb_cpu_JP_Z_a16, {3, CUSTOM_CYCLES, 0}},
				{gb_cpu_PREFIX, {1, 1, 0}},
				{gb_cpu_CALL_Z_a16, {3, CUSTOM_CYCLES, 0}},
				{gb_cpu_CALL_a16, {3, 6, 0}},
				{gb_cpu_ADC_A_d8, {2, 2, 0}},
				{gb_cpu_RST_08H, {1, 4, 0}},
				{gb_cpu_RET_NC, {1, CUSTOM_CYCLES, 0}},
				{gb_cpu_POP_DE, {1, 3, 0}},
				{gb_cpu_JP_NC_a16, {3, CUSTOM_CYCLES, 0}},
				{NULL, {0, 0, 0}},
				{gb_cpu_CALL_NC_a16, {3, CUSTOM_CYCLES, 0}},
				{gb_cpu_PUSH_DE, {1, 4, 0}},
				{gb_cpu_SUB_d8, {2, 2, 0}},
				{gb_cpu_RST_10H, {1, 4, 0}},
				{gb_cpu_RET_C, {1, CUSTOM_CYCLES, 0}},
				{gb_cpu_RETI, {1, 4, 0}},
				{gb_cpu_JP_C_a16, {3, CUSTOM_CYCLES, 0}},
				{NULL, {0, 0, 0}},
				{gb_cpu_CALL_C_a16, {3, CUSTOM_CYCLES, 0}},
				{NULL, {0, 0, 0}},
				{gb_cpu_SBC_A_d8, {2, 2, 0}},
				{gb_cpu_RST_18H, {1, 4, 0}},
				{gb_cpu_LOAD_a8_A, {2, 3, 0}},
				{gb_cpu_POP_HL, {1, 3, 0}},
				{gb_cpu_LOAD_fC_A, {1, 2, 0}},
				{NULL, {0, 0, 0}},
				{NULL, {0, 0, 0}},
				{gb_cpu_PUSH_HL, {1, 4, 0}},
				{gb_cpu_AND_d8, {2, 2, 0}},
				{gb_cpu_RST20H, {1, 4, 0}},
				{gb_cpu_ADD_SP_r8, {2, 4, 0}},
				{gb_cpu_JP_HL, {1, 1, 0}},
				{gb_cpu_LOAD_a16_A, {3, 4, 0}},
				{NULL, {0, 0, 0}},
				{NULL, {0, 0, 0}},
				{NULL, {0, 0, 0}},
				{gb_cpu_XOR_d8, {2, 2, 0}},
				{gb_cpu_RST_28H, {1, 4, 0}},
				{gb_cpu_LOAD_A_a8, {2, 3, 0}},
				{gb_cpu_POP_AF, {1, 3, 0}},
				{gb_cpu_LOAD_A_fC, {1, 2, 0}},
				{gb_cpu_DI, {1, 1, 0}},
				{NULL, {0, 0, 0}},
				{gb_cpu_PUSH_AF, {1, 4, 0}},
				{gb_cpu_OR_d8, {2, 2, 0}},
				{gb_cpu_RST_30H, {1, 4, 0}},
				{gb_cpu_LOAD_HL_SP_r8, {2, 3, 0}},
				{gb_cpu_LOAD_SP_HL, {1, 2, 0}},
				{gb_cpu_LOAD_A_a16, {3, 4, 0}},
				{gb_cpu_EI, {1, 1, 0}},
				{NULL, {0, 0, 0}},
				{NULL, {0, 0, 0}},
				{gb_cpu_CP_d8, {2, 2, 0}},
				{gb_cpu_RST_38H, {1, 4, 0}}};

gb_instr_t prefix_instructions[256] = {
	{gb_cpu_RLC_B, {2, 2, 0}},    {gb_cpu_RLC_C, {2, 2, 0}},    {gb_cpu_RLC_D, {2, 2, 0}},
	{gb_cpu_RLC_E, {2, 2, 0}},    {gb_cpu_RLC_H, {2, 2, 0}},    {gb_cpu_RLC_L, {2, 2, 0}},
	{gb_cpu_RLC_HL, {2, 4, 0}},   {gb_cpu_RLC_A, {2, 2, 0}},    {gb_cpu_RRC_B, {2, 2, 0}},
	{gb_cpu_RRC_C, {2, 2, 0}},    {gb_cpu_RRC_D, {2, 2, 0}},    {gb_cpu_RRC_E, {2, 2, 0}},
	{gb_cpu_RRC_H, {2, 2, 0}},    {gb_cpu_RRC_L, {2, 2, 0}},    {gb_cpu_RRC_HL, {2, 4, 0}},
	{gb_cpu_RRC_A, {2, 2, 0}},    {gb_cpu_RL_B, {2, 2, 0}},	    {gb_cpu_RL_C, {2, 2, 0}},
	{gb_cpu_RL_D, {2, 2, 0}},     {gb_cpu_RL_E, {2, 2, 0}},	    {gb_cpu_RL_H, {2, 2, 0}},
	{gb_cpu_RL_L, {2, 2, 0}},     {gb_cpu_RL_HL, {2, 4, 0}},    {gb_cpu_RL_A, {2, 2, 0}},
	{gb_cpu_RR_B, {2, 2, 0}},     {gb_cpu_RR_C, {2, 2, 0}},	    {gb_cpu_RR_D, {2, 2, 0}},
	{gb_cpu_RR_E, {2, 2, 0}},     {gb_cpu_RR_H, {2, 2, 0}},	    {gb_cpu_RR_L, {2, 2, 0}},
	{gb_cpu_RR_HL, {2, 4, 0}},    {gb_cpu_RR_A, {2, 2, 0}},	    {gb_cpu_SLA_B, {2, 2, 0}},
	{gb_cpu_SLA_C, {2, 2, 0}},    {gb_cpu_SLA_D, {2, 2, 0}},    {gb_cpu_SLA_E, {2, 2, 0}},
	{gb_cpu_SLA_H, {2, 2, 0}},    {gb_cpu_SLA_L, {2, 2, 0}},    {gb_cpu_SLA_HL, {2, 4, 0}},
	{gb_cpu_SLA_A, {2, 2, 0}},    {gb_cpu_SRA_B, {2, 2, 0}},    {gb_cpu_SRA_C, {2, 2, 0}},
	{gb_cpu_SRA_D, {2, 2, 0}},    {gb_cpu_SRA_E, {2, 2, 0}},    {gb_cpu_SRA_H, {2, 2, 0}},
	{gb_cpu_SRA_L, {2, 2, 0}},    {gb_cpu_SRA_HL, {2, 4, 0}},   {gb_cpu_SRA_A, {2, 2, 0}},
	{gb_cpu_SWAP_B, {2, 2, 0}},   {gb_cpu_SWAP_C, {2, 2, 0}},   {gb_cpu_SWAP_D, {2, 2, 0}},
	{gb_cpu_SWAP_E, {2, 2, 0}},   {gb_cpu_SWAP_H, {2, 2, 0}},   {gb_cpu_SWAP_L, {2, 2, 0}},
	{gb_cpu_SWAP_HL, {2, 4, 0}},  {gb_cpu_SWAP_A, {2, 2, 0}},   {gb_cpu_SRL_B, {2, 2, 0}},
	{gb_cpu_SRL_C, {2, 2, 0}},    {gb_cpu_SRL_D, {2, 2, 0}},    {gb_cpu_SRL_E, {2, 2, 0}},
	{gb_cpu_SRL_H, {2, 2, 0}},    {gb_cpu_SRL_L, {2, 2, 0}},    {gb_cpu_SRL_HL, {2, 4, 0}},
	{gb_cpu_SRL_A, {2, 2, 0}},    {gb_cpu_BIT_0_B, {2, 2, 0}},  {gb_cpu_BIT_0_C, {2, 2, 0}},
	{gb_cpu_BIT_0_D, {2, 2, 0}},  {gb_cpu_BIT_0_E, {2, 2, 0}},  {gb_cpu_BIT_0_H, {2, 2, 0}},
	{gb_cpu_BIT_0_L, {2, 2, 0}},  {gb_cpu_BIT_0_HL, {2, 3, 0}}, {gb_cpu_BIT_0_A, {2, 2, 0}},
	{gb_cpu_BIT_1_B, {2, 2, 0}},  {gb_cpu_BIT_1_C, {2, 2, 0}},  {gb_cpu_BIT_1_D, {2, 2, 0}},
	{gb_cpu_BIT_1_E, {2, 2, 0}},  {gb_cpu_BIT_1_H, {2, 2, 0}},  {gb_cpu_BIT_1_L, {2, 2, 0}},
	{gb_cpu_BIT_1_HL, {2, 3, 0}}, {gb_cpu_BIT_1_A, {2, 2, 0}},  {gb_cpu_BIT_2_B, {2, 2, 0}},
	{gb_cpu_BIT_2_C, {2, 2, 0}},  {gb_cpu_BIT_2_D, {2, 2, 0}},  {gb_cpu_BIT_2_E, {2, 2, 0}},
	{gb_cpu_BIT_2_H, {2, 2, 0}},  {gb_cpu_BIT_2_L, {2, 2, 0}},  {gb_cpu_BIT_2_HL, {2, 3, 0}},
	{gb_cpu_BIT_2_A, {2, 2, 0}},  {gb_cpu_BIT_3_B, {2, 2, 0}},  {gb_cpu_BIT_3_C, {2, 2, 0}},
	{gb_cpu_BIT_3_D, {2, 2, 0}},  {gb_cpu_BIT_3_E, {2, 2, 0}},  {gb_cpu_BIT_3_H, {2, 2, 0}},
	{gb_cpu_BIT_3_L, {2, 2, 0}},  {gb_cpu_BIT_3_HL, {2, 3, 0}}, {gb_cpu_BIT_3_A, {2, 2, 0}},
	{gb_cpu_BIT_4_B, {2, 2, 0}},  {gb_cpu_BIT_4_C, {2, 2, 0}},  {gb_cpu_BIT_4_D, {2, 2, 0}},
	{gb_cpu_BIT_4_E, {2, 2, 0}},  {gb_cpu_BIT_4_H, {2, 2, 0}},  {gb_cpu_BIT_4_L, {2, 2, 0}},
	{gb_cpu_BIT_4_HL, {2, 3, 0}}, {gb_cpu_BIT_4_A, {2, 2, 0}},  {gb_cpu_BIT_5_B, {2, 2, 0}},
	{gb_cpu_BIT_5_C, {2, 2, 0}},  {gb_cpu_BIT_5_D, {2, 2, 0}},  {gb_cpu_BIT_5_E, {2, 2, 0}},
	{gb_cpu_BIT_5_H, {2, 2, 0}},  {gb_cpu_BIT_5_L, {2, 2, 0}},  {gb_cpu_BIT_5_HL, {2, 3, 0}},
	{gb_cpu_BIT_5_A, {2, 2, 0}},  {gb_cpu_BIT_6_B, {2, 2, 0}},  {gb_cpu_BIT_6_C, {2, 2, 0}},
	{gb_cpu_BIT_6_D, {2, 2, 0}},  {gb_cpu_BIT_6_E, {2, 2, 0}},  {gb_cpu_BIT_6_H, {2, 2, 0}},
	{gb_cpu_BIT_6_L, {2, 2, 0}},  {gb_cpu_BIT_6_HL, {2, 3, 0}}, {gb_cpu_BIT_6_A, {2, 2, 0}},
	{gb_cpu_BIT_7_B, {2, 2, 0}},  {gb_cpu_BIT_7_C, {2, 2, 0}},  {gb_cpu_BIT_7_D, {2, 2, 0}},
	{gb_cpu_BIT_7_E, {2, 2, 0}},  {gb_cpu_BIT_7_H, {2, 2, 0}},  {gb_cpu_BIT_7_L, {2, 2, 0}},
	{gb_cpu_BIT_7_HL, {2, 3, 0}}, {gb_cpu_BIT_7_A, {2, 2, 0}},  {gb_cpu_RES_0_B, {2, 2, 0}},
	{gb_cpu_RES_0_C, {2, 2, 0}},  {gb_cpu_RES_0_D, {2, 2, 0}},  {gb_cpu_RES_0_E, {2, 2, 0}},
	{gb_cpu_RES_0_H, {2, 2, 0}},  {gb_cpu_RES_0_L, {2, 2, 0}},  {gb_cpu_RES_0_HL, {2, 4, 0}},
	{gb_cpu_RES_0_A, {2, 2, 0}},  {gb_cpu_RES_1_B, {2, 2, 0}},  {gb_cpu_RES_1_C, {2, 2, 0}},
	{gb_cpu_RES_1_D, {2, 2, 0}},  {gb_cpu_RES_1_E, {2, 2, 0}},  {gb_cpu_RES_1_H, {2, 2, 0}},
	{gb_cpu_RES_1_L, {2, 2, 0}},  {gb_cpu_RES_1_HL, {2, 4, 0}}, {gb_cpu_RES_1_A, {2, 2, 0}},
	{gb_cpu_RES_2_B, {2, 2, 0}},  {gb_cpu_RES_2_C, {2, 2, 0}},  {gb_cpu_RES_2_D, {2, 2, 0}},
	{gb_cpu_RES_2_E, {2, 2, 0}},  {gb_cpu_RES_2_H, {2, 2, 0}},  {gb_cpu_RES_2_L, {2, 2, 0}},
	{gb_cpu_RES_2_HL, {2, 4, 0}}, {gb_cpu_RES_2_A, {2, 2, 0}},  {gb_cpu_RES_3_B, {2, 2, 0}},
	{gb_cpu_RES_3_C, {2, 2, 0}},  {gb_cpu_RES_3_D, {2, 2, 0}},  {gb_cpu_RES_3_E, {2, 2, 0}},
	{gb_cpu_RES_3_H, {2, 2, 0}},  {gb_cpu_RES_3_L, {2, 2, 0}},  {gb_cpu_RES_3_HL, {2, 4, 0}},
	{gb_cpu_RES_3_A, {2, 2, 0}},  {gb_cpu_RES_4_B, {2, 2, 0}},  {gb_cpu_RES_4_C, {2, 2, 0}},
	{gb_cpu_RES_4_D, {2, 2, 0}},  {gb_cpu_RES_4_E, {2, 2, 0}},  {gb_cpu_RES_4_H, {2, 2, 0}},
	{gb_cpu_RES_4_L, {2, 2, 0}},  {gb_cpu_RES_4_HL, {2, 4, 0}}, {gb_cpu_RES_4_A, {2, 2, 0}},
	{gb_cpu_RES_5_B, {2, 2, 0}},  {gb_cpu_RES_5_C, {2, 2, 0}},  {gb_cpu_RES_5_D, {2, 2, 0}},
	{gb_cpu_RES_5_E, {2, 2, 0}},  {gb_cpu_RES_5_H, {2, 2, 0}},  {gb_cpu_RES_5_L, {2, 2, 0}},
	{gb_cpu_RES_5_HL, {2, 4, 0}}, {gb_cpu_RES_5_A, {2, 2, 0}},  {gb_cpu_RES_6_B, {2, 2, 0}},
	{gb_cpu_RES_6_C, {2, 2, 0}},  {gb_cpu_RES_6_D, {2, 2, 0}},  {gb_cpu_RES_6_E, {2, 2, 0}},
	{gb_cpu_RES_6_H, {2, 2, 0}},  {gb_cpu_RES_6_L, {2, 2, 0}},  {gb_cpu_RES_6_HL, {2, 4, 0}},
	{gb_cpu_RES_6_A, {2, 2, 0}},  {gb_cpu_RES_7_B, {2, 2, 0}},  {gb_cpu_RES_7_C, {2, 2, 0}},
	{gb_cpu_RES_7_D, {2, 2, 0}},  {gb_cpu_RES_7_E, {2, 2, 0}},  {gb_cpu_RES_7_H, {2, 2, 0}},
	{gb_cpu_RES_7_L, {2, 2, 0}},  {gb_cpu_RES_7_HL, {2, 4, 0}}, {gb_cpu_RES_7_A, {2, 2, 0}},
	{gb_cpu_SET_0_B, {2, 2, 0}},  {gb_cpu_SET_0_C, {2, 2, 0}},  {gb_cpu_SET_0_D, {2, 2, 0}},
	{gb_cpu_SET_0_E, {2, 2, 0}},  {gb_cpu_SET_0_H, {2, 2, 0}},  {gb_cpu_SET_0_L, {2, 2, 0}},
	{gb_cpu_SET_0_HL, {2, 4, 0}}, {gb_cpu_SET_0_A, {2, 2, 0}},  {gb_cpu_SET_1_B, {2, 2, 0}},
	{gb_cpu_SET_1_C, {2, 2, 0}},  {gb_cpu_SET_1_D, {2, 2, 0}},  {gb_cpu_SET_1_E, {2, 2, 0}},
	{gb_cpu_SET_1_H, {2, 2, 0}},  {gb_cpu_SET_1_L, {2, 2, 0}},  {gb_cpu_SET_1_HL, {2, 4, 0}},
	{gb_cpu_SET_1_A, {2, 2, 0}},  {gb_cpu_SET_2_B, {2, 2, 0}},  {gb_cpu_SET_2_C, {2, 2, 0}},
	{gb_cpu_SET_2_D, {2, 2, 0}},  {gb_cpu_SET_2_E, {2, 2, 0}},  {gb_cpu_SET_2_H, {2, 2, 0}},
	{gb_cpu_SET_2_L, {2, 2, 0}},  {gb_cpu_SET_2_HL, {2, 4, 0}}, {gb_cpu_SET_2_A, {2, 2, 0}},
	{gb_cpu_SET_3_B, {2, 2, 0}},  {gb_cpu_SET_3_C, {2, 2, 0}},  {gb_cpu_SET_3_D, {2, 2, 0}},
	{gb_cpu_SET_3_E, {2, 2, 0}},  {gb_cpu_SET_3_H, {2, 2, 0}},  {gb_cpu_SET_3_L, {2, 2, 0}},
	{gb_cpu_SET_3_HL, {2, 4, 0}}, {gb_cpu_SET_3_A, {2, 2, 0}},  {gb_cpu_SET_4_B, {2, 2, 0}},
	{gb_cpu_SET_4_C, {2, 2, 0}},  {gb_cpu_SET_4_D, {2, 2, 0}},  {gb_cpu_SET_4_E, {2, 2, 0}},
	{gb_cpu_SET_4_H, {2, 2, 0}},  {gb_cpu_SET_4_L, {2, 2, 0}},  {gb_cpu_SET_4_HL, {2, 4, 0}},
	{gb_cpu_SET_4_A, {2, 2, 0}},  {gb_cpu_SET_5_B, {2, 2, 0}},  {gb_cpu_SET_5_C, {2, 2, 0}},
	{gb_cpu_SET_5_D, {2, 2, 0}},  {gb_cpu_SET_5_E, {2, 2, 0}},  {gb_cpu_SET_5_H, {2, 2, 0}},
	{gb_cpu_SET_5_L, {2, 2, 0}},  {gb_cpu_SET_5_HL, {2, 4, 0}}, {gb_cpu_SET_5_A, {2, 2, 0}},
	{gb_cpu_SET_6_B, {2, 2, 0}},  {gb_cpu_SET_6_C, {2, 2, 0}},  {gb_cpu_SET_6_D, {2, 2, 0}},
	{gb_cpu_SET_6_E, {2, 2, 0}},  {gb_cpu_SET_6_H, {2, 2, 0}},  {gb_cpu_SET_6_L, {2, 2, 0}},
	{gb_cpu_SET_6_HL, {2, 4, 0}}, {gb_cpu_SET_6_A, {2, 2, 0}},  {gb_cpu_SET_7_B, {2, 2, 0}},
	{gb_cpu_SET_7_C, {2, 2, 0}},  {gb_cpu_SET_7_D, {2, 2, 0}},  {gb_cpu_SET_7_E, {2, 2, 0}},
	{gb_cpu_SET_7_H, {2, 2, 0}},  {gb_cpu_SET_7_L, {2, 2, 0}},  {gb_cpu_SET_7_HL, {2, 4, 0}},
	{gb_cpu_SET_7_A, {2, 2, 0}}};
...
{
	(void)info;
	int8_t r8_val = (int8_t)gb_memory_read(reg.PC - 1); // to do cycle 1
...
{
	(void)info;
	((gb_memory_read(reg.HL) & 0x0F) == 0x0F) ? SET_BIT(reg.F, H_FLAG_BIT)
						  : RST_BIT(reg.F, H_FLAG_BIT);
	gb_memory_write(reg.HL, gb_memory_read(reg.HL) + 1);
	RST_BIT(reg.F, N_FLAG_BIT);
	(gb_memory_read(reg.HL) != 0) ? RST_BIT(reg.F, Z_FLAG_BIT) : SET_BIT(reg.F, Z_FLAG_BIT);
}
void gb_cpu_DEC_HL_ADDR(gb_instr_info_t *info)
{
	(void)info;

	((gb_memory_read(reg.HL) & 0x0F) != 0) ? RST_BIT(reg.F, H_FLAG_BIT)
					       : SET_BIT(reg.F, H_FLAG_BIT);
	gb_memory_write(reg.HL, gb_memory_read(reg.HL) - 1);
	SET_BIT(reg.F, N_FLAG_BIT);
	(gb_memory_read(reg.HL) != 0) ? RST_BIT(reg.F, Z_FLAG_BIT) : SET_BIT(reg.F, Z_FLAG_BIT);
...
{
	(void)info;
	uint8_t temp_val = gb_memory_read(reg.HL);
...
{
	(void)info;
	gb_cpu_reset_HL_address_bit(&reg.HL, 0);
}
...
{
	(void)info;
	gb_cpu_reset_HL_address_bit(&reg.HL, 1);
}
...
{
	(void)info;
	gb_cpu_reset_HL_address_bit(&reg.HL, 2);
}
...
{
	(void)info;
	gb_cpu_reset_HL_address_bit(&reg.HL, 3);
}
...
{
	(void)info;
	gb_cpu_reset_HL_address_bit(&reg.HL, 4);
}
...
{
	(void)info;
	gb_cpu_reset_HL_address_bit(&reg.HL, 5);
}
...
{
	(void)info;
	gb_cpu_reset_HL_address_bit(&reg.HL, 6);
}
...
{
	(void)info;
	gb_cpu_reset_HL_address_bit(&reg.HL, 7);
}
...
{
	(void)info;
	gb_cpu_set_HL_address_bit(&reg.HL, 0);
}
...
{
	(void)info;
	gb_cpu_set_HL_address_bit(&reg.HL, 1);
}
...
{
	(void)info;
	gb_cpu_set_HL_address_bit(&reg.HL, 2);
}
...
{
	(void)info;
	gb_cpu_set_HL_address_bit(&reg.HL, 3);
}
...
{
	(void)info;
	gb_cpu_set_HL_address_bit(&reg.HL, 4);
}
...
{
	(void)info;
	gb_cpu_set_HL_address_bit(&reg.HL, 5);
}
...
{
	(void)info;
	gb_cpu_set_HL_address_bit(&reg.HL, 6);
}
...
{
	(void)info;
	gb_cpu_set_HL_address_bit(&reg.HL, 7);
}
...
{
	// LOG_INF("addr: %x, op: %x", reg.PC, opcode);
	...
	if (op_remaining <= 0) {
		...
		/* TEMPORARY FOR NOW */
		/* TRY MODIFYING STRUCT AND PASSING IT TO FUNCTIONS */
		((void (*)(gb_instr_info_t *))instructions[opcode].instr)(
			&instructions[opcode].info);
	}

	/* Execute instr (on 1 cycle) */
