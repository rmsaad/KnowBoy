...
/* NR52 */
#define CH1_ON_OFFSET	0
#define CH2_ON_OFFSET	1
#define CH3_ON_OFFSET	2
#define CH4_ON_OFFSET	3
#define AUDIO_ON_OFFSET 7
...
/* NR10 */
#define CH1_SWEEP_STEP_OFFSET 0
#define CH1_SWEEP_DIR_OFFSET  3
#define CH1_SWEEP_PACE_OFFSET 4
#define CH1_SWEEP_STEP	      (BIT_POS_0 + BIT_POS_1 + BIT_POS_2)
#define CH1_SWEEP_DIR	      BIT_POS_3
#define CH1_SWEEP_PACE	      (BIT_POS_4 + BIT_POS_5 + BIT_POS_6)
...
/* NR12 */
#define CH1_ENV_PACE_OFFSET    0
#define CH1_ENV_DIR_OFFSET     3
#define CH1_INITIAL_VOL_OFFSET 4
#define CH1_ENV_PACE	       (BIT_POS_0 + BIT_POS_1 + BIT_POS_2)
#define CH1_ENV_DIR	       (BIT_POS_3)
...
/* NR22 */
#define CH2_ENV_PACE_OFFSET    0
#define CH2_ENV_DIR_OFFSET     3
#define CH2_INITIAL_VOL_OFFSET 4
#define CH2_ENV_PACE	       (BIT_POS_0 + BIT_POS_1 + BIT_POS_2)
#define CH2_ENV_DIR	       (BIT_POS_3)
...
/* NR32 */
#define CH3_OUTPUT_LVL_OFFSET 5
#define CH3_OUTPUT_LVL	      (BIT_POS_5 + BIT_POS_6)
...
/* NR42 */
#define CH4_ENV_PACE_OFFSET    0
#define CH4_ENV_DIR_OFFSET     3
#define CH4_INITIAL_VOL_OFFSET 4
#define CH4_ENV_PACE	       (BIT_POS_0 + BIT_POS_1 + BIT_POS_2)
#define CH4_ENV_DIR	       (BIT_POS_3)
#define CH4_INITIAL_VOL	       (BIT_POS_4 + BIT_POS_5 + BIT_POS_6 + BIT_POS_7)

/* NR43 */
#define CH4_CLK_DIV_OFFSET    0
#define CH4_LFSR_WIDTH_OFFSET 3
#define CH4_CLK_SHIFT_OFFSET  4
#define CH4_CLK_DIV	      (BIT_POS_0 + BIT_POS_1 + BIT_POS_2)
#define CH4_LFSR_WIDTH	      (BIT_POS_3)
#define CH4_CLK_SHIFT	      (BIT_POS_4 + BIT_POS_5 + BIT_POS_6 + BIT_POS_7)
